...
<display:table name="banner" id="banner" requestURI="banner/list.do"
	pagesize="5" class="displaytag">
	
	<spring:message code="banner.logo" var="logoHeader" />
	<display:column property="logo" title="${logoHeader }" sortable="true" />
	
	<spring:message code="banner.display" var="displayHeader" />
	<display:column property="display" title="${displayHeader }" sortable="true" />
