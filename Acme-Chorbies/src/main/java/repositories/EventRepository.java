...
//	@Query("select e from Event e where year(current_Date)=year(e.moment) and (month(current_Date)=month(e.moment)and day(current_Date)>=day(e.moment) or (month(current_Date)=month(e.moment)+1 and abs(day(current_Date)-day(e.moment))<=30))")
